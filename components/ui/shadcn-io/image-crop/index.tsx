...
// High-quality crop export (WebP or JPEG)
const getCroppedImageHighQuality = async (
...
export const ImageCrop = ({
  ...
  const applyCrop = async () => {
    ...
    const croppedImage = await getCroppedImageHighQuality(
      imgRef.current,
      completedCrop,
      'image/webp',
      0.98
...
export const Cropper = ({
  ...
  <ImageCrop file={file} onChange={onChange} onComplete={onComplete} onCrop={onCrop} {...props}>
